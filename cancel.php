...
<head>
  ...
  <style>
    :root{--bg:#0b1020;--card:#0f1724;--muted:#9aa6bf;--danger:#ff6b6b}
...
<body>
  <div class="card">
    ...
    <?php if ($error && $error['txid'] === $tx): ?>
      <p><strong>Transaction ID:</strong> <?php echo htmlspecialchars($error['txid']); ?></p>
      <p><strong>Reason:</strong> <?php echo htmlspecialchars($error['reason']); ?></p>
    <?php else: ?>
      <p>Payment was not completed. Session may have expired.</p>
    <?php endif; ?>
